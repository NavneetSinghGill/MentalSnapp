...
- (void)initialiseTutoarialsData
{
    if(self.isFirstTutorial)
    {
        ...
        self.descriptions = @[@"Thank you for downloading Mental Snapp; a new video diary service for people actively managing their mental health.\n\nThe purpose of recording video diaries with Mental Snapp is to make your voice and awareness of your mental health useful to you. We believe that you already have the skills to manage your mental health successfully, and creating video diaries on a regular basis can draw out the expertise you have already.",
                              @"We encourage you to record freeform or in your own words as much as possible so it becomes part and parcel of your routine. You can set regular times to record, whenever the time is right for you.\n\nWe recognise this may take a bit of getting used to! We’ve created some optional prompts to help you through the first few videos.",
                              ...
                              @"After you have selected an exercise category and subcategory, the individual exercises come up as single questions. You can swipe right to select the question you want to answer. \nYou then press record now - or if you would rather - schedule the exercise for later using the calendar icon. You can see your queued exercises on the ‘More’ tab.",
                              @"After recording, then you rate your mood, from ‘the best’ to ‘the worst’ or grades in between using the wheel. You then give the video a feeling - these are taken from Plutchik, a recognised system of emotional categories.\n\nYou also have the option to add your own free text as tags. These ratings and tags will form an overview of how you are doing so you can track your feelings and emotions.",
                              @"Over time you will be able to track your mood and gain insight on your mental health. In doing so, you will be able to take control again. You can review the videos any time.\n\nSingle click on a point on the graph to show the tags and name of the video - double click on a point to play the video.",
                              @"You can search the videos by date, exercise category, feeling or any of the freeform text you have entered against them.\n\nYou can play the videos and share them with others - but only if you show them yourself on your phone. \n\nThat way you can get an immediate response and you know they’ve been seen.",
                              @"Your data is important to us so we have put policies in place to protect it. We are compliant with the Information Commissioners Office.\n\nWe make our Terms and Conditions and Privacy Policy available on our website as well as in the app here.",
                              @"Your data remains yours, and you can download the videos at any time.\nYou also have the right to delete your data when you delete the app.\n\nWe wouldn’t want our time together to be cut short, but if you did want to leave we aim to make it easy for you.",
                              @"You can customise your profile to make it useful to you.\n\nYou might want to set a reminder to record Mental Snapp, daily, every few days, or weekly. It’s up to you.",
